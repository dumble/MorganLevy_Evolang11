...
\begin{center}
 ...
 & $\nu = 1$ &  $\nu = 10$
  \\
  $N=10$ & \pbox[c]{\textwidth}{\includegraphics[scale=.3]{../sims-R-1-1-dotted.pdf}}
%  & \pbox[c]{\textwidth}{\includegraphics[scale=.3]{sims-10-1.pdf}}
  & \pbox[c]{\textwidth}{\includegraphics[scale=.3]{../sims-R-10-1-dotted.pdf}}
\\
  $N=100$ & \pbox[c]{\textwidth}{\includegraphics[scale=.3]{../sims-R-1-2-dotted.pdf}}
%    & \pbox[c]{\textwidth}{\includegraphics[scale=.3]{sims-10-2.pdf}}
  & \pbox[c]{\textwidth}{\includegraphics[scale=.3]{../sims-R-10-2-dotted.pdf}}
\\
  $N=200$ & \pbox[c]{\textwidth}{\includegraphics[scale=.3]{../sims-R-1-3-dotted.pdf}}
%    & \pbox[c]{\textwidth}{\includegraphics[scale=.3]{sims-10-3.pdf}}
  & \pbox[c]{\textwidth}{\includegraphics[scale=.3]{../sims-R-10-3-dotted.pdf}}
\\
  $N=500$ & \pbox[c]{\textwidth}{\includegraphics[scale=.3]{../sims-R-1-4-dotted.pdf}}
%    & \pbox[c]{\textwidth}{\includegraphics[scale=.3]{sims-10-4.pdf}}
  & \pbox[c]{\textwidth}{\includegraphics[scale=.3]{../sims-R-10-4-dotted.pdf}}
